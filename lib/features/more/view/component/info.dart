    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              // TODO: Phase 2 — Certificates hidden until feature is ready
              // InfoBoxCard(
              //     icon: 'assets/svg/ic_certificates.svg',
              //     title: S.of(context).certificates,
              //     color: colors(context).primaryColor ?? AppStaticColor.primaryColor,
              //     onTap: () => context.nav.pushNamed(Routes.certificateScreen)),
              // 16.pw,
