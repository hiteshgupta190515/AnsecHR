                                            ...
                                            child: LayoutBuilder(
                                              builder: (context, constraints) {
                                                final courses = ref
                                                    ...
                                                    .courseList;
                                                // Use LayoutBuilder's actual pixel width so the
                                                // grid is responsive on every screen size.
                                                final gapPx = 10.w;
                                                // CourseCard applies .w internally, so convert
                                                // pixel width back to design units.
                                                final cardWidth =
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            CourseCard(
                                                              ...
                                                              width: cardWidth,
                                                              height: 160,
                                                              // showMeta: true, // Uncomment to restore price, enrolled count & ratings
                                                              showMeta: false,
                                                              showRating: true,
                                                              onTap: () {
                                                                if (first
