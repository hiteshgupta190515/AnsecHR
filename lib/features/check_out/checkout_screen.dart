...
import '../auth/widget/login_bottom_widget.dart';
import '../auth/widget/otp_bottom_widget.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              AppButton(
                ...
                onTap: () {
                  Navigator.pop(context); // Close the dialog.
                  context.nav.pushNamedAndRemoveUntil(Routes.myCourseDetails,
                      arguments: widget.courseID, (route)=>false);
