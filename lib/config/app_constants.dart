class AppConstants {
  ...
  static const String validateOtpForResetPass = '$baseUrl/reset-password/validate';
  ...
  static const String activeAccountRequest = '$baseUrl/account-activation/send-code';
  ...
  static const String getFeaturedInstructor = '$baseUrl/instructor/list?is_featured=1';
  ...
  static String appName = 'Career Compass';
