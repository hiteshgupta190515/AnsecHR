...
import '../features/notification/component/notification_card.dart';
...
void showFlutterNotification(RemoteMessage message) {
  // Show notification for any message that has a title or body,
  // regardless of whether platform-specific objects (android/iOS) are present.
